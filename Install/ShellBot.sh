...
if ! awk 'BEGIN { exit ARGV[1] < 4.3 }' ${BASH_VERSINFO[0]}.${BASH_VERSINFO[1]}; then
	echo "${BASH_SOURCE:-${0##*/}}: Erreur : Nécessite l'interpréteur de commandes 'Bash 4.3' ou supérieur." 1>&2
	exit 1
fi
...
[description]='API non officielle pour créer des bots sur la plateforme Telegram.'
[version]='6.4.0'
[language]='shellscript'
[shell]=${SHELL}
[shell_version]=${BASH_VERSION}
[author]='Alphannec'
[email]='setyurialphannec@gmail.com'
...
# Erros
readonly _ERR_TYPE_BOOL_='Type incompatible : Prend en charge uniquement "true" ou "false".'
...
readonly _ERR_TOKEN_INVALID_='Jeton non valide : vérifiez le numéro du jeton et réessayez.'
readonly _ERR_BOT_ALREADY_INIT_='Action non autorisée : le bot a déjà été initialisé.'
readonly _ERR_FILE_NOT_FOUND_="Échec de l'accès : Impossible de lire le fichier."
...
readonly _ERR_UNKNOWN_="Erreur inconnue : une défaillance inattendue s'est produite. Signalez le problème au développeur."
...
readonly _ERR_SERVICE_SYSTEMD_NOT_FOUND_="Erreur lors de l'activation : le système ne prend pas en charge la gestion des services 'systemd'".
...
readonly _ERR_FUNCTION_NOT_FOUND_="Fonction introuvable : l'identifiant spécifié n'est pas valide ou n'existe pas."
readonly _ERR_ARG_="Argument invalide : l'argument n'est pas pris en charge par le paramètre spécifié."
readonly _ERR_RULE_ALREADY_EXISTS_="Échec de la définition : le nom de la règle existe déjà."
...
_eof
	...
	[[ $? -eq 0 ]] && {	
		...
		printf '%s a été créé avec succès !!\n' $service	
		echo -n "Permettant..."
