...
fun_udp1 () {
    [[ -e "/bin/badvpn-udpgw" ]] && {
    clear
    echo -e "\033[1;32mDEMARRAGE DE  BADVPN... \033[0m\n"
    fun_udpon () {
    ...
    menu
        ...
        clear
        echo -e "\033[1;32mINSTALLATION DE BADVPN !\033[0m\n"
	    inst_udp () {
	        cd $HOME
			apt-get install dos2unix -y
            wget https://raw.githubusercontent.com/Alphathennec/SERVEUR/main/badvpn/badvpn-udpgw -o /dev/null
			wget https://raw.githubusercontent.com/Alphathennec/SERVEUR/main/badvpn/antcrashvpn.sh -o /dev/null
	   ...
	   fun_bar 'inst_udp'
	   echo -e "\n\033[1;32mDEMARRAGE DE BADVPN... \033[0m\n"
       fun_udpon2 () {
           screen -dmS udpvpn /bin/antcrashvpn.sh
           [[ $(grep -wc "udpvpn" /etc/autostart) = '0' ]] && {
...
fun_udp2 () {
    clear
    echo -e "\n\033[1;32mARRÊT DE BADVPN...\033[0m\n"
    fun_stopbad () {
        sleep 1
